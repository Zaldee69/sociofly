...
import { Facebook, Instagram, Linkedin, PenLine, Twitter, Wand } from "lucide-react";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
...
const SchedulePost: React.FC = () => {
  ...
  const accounts = mockAccounts.map((account) => {
    const IconComponent = account.platform === "instagram" ? Instagram :
      ...
      account.platform === "tiktok" ? Facebook : undefined;
              ...
              <form onSubmit={handleSubmit}>
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-xs text-muted-foreground">
                    <span>Use AI to generate caption and tags</span>
                ...
                <div className="space-y-2 mt-4">
                  ...
                  {imagePreview ? (
                    ...
                    <div className="border-2 border-dashed rounded-md hover:border-primary/50 transition-colors h-11/12">
