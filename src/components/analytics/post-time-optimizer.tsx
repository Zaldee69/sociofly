...
const mockOptimalTimes = {
  instagram: [
    { day: "Senin", time: "19:00 - 21:00", engagement: "tinggi", audience: "74%", hourlyBreakdown: [
    ...
    { day: "Selasa", time: "18:00 - 20:00", engagement: "sedang", audience: "61%", hourlyBreakdown: [
    ...
    { day: "Rabu", time: "12:00 - 13:00", engagement: "tinggi", audience: "72%", hourlyBreakdown: [
      { hour: "11:00", percentage: 52 },
      { hour: "12:00", percentage: 72 },
      { hour: "13:00", percentage: 67 },
      { hour: "14:00", percentage: 50 }
    ]},
    { day: "Kamis", time: "17:00 - 19:00", engagement: "sedang", audience: "58%", hourlyBreakdown: [
    ...
    { day: "Jumat", time: "20:00 - 22:00", engagement: "sangat tinggi", audience: "81%", hourlyBreakdown: [
      { hour: "19:00", percentage: 65 },
      { hour: "20:00", percentage: 75 },
      { hour: "21:00", percentage: 81 },
      { hour: "22:00", percentage: 72 }
    ]},
    { day: "Sabtu", time: "14:00 - 16:00", engagement: "tinggi", audience: "76%", hourlyBreakdown: [
    ...
    { day: "Minggu", time: "15:00 - 18:00", engagement: "sangat tinggi", audience: "85%", hourlyBreakdown: [
  ...
  facebook: [
    { day: "Senin", time: "13:00 - 15:00", engagement: "sedang", audience: "55%", hourlyBreakdown: [
      { hour: "12:00", percentage: 42 },
      { hour: "13:00", percentage: 50 },
      { hour: "14:00", percentage: 55 },
      { hour: "15:00", percentage: 48 }
    ]},
    { day: "Selasa", time: "12:00 - 14:00", engagement: "sedang", audience: "58%", hourlyBreakdown: [
      { hour: "11:00", percentage: 45 },
      { hour: "12:00", percentage: 52 },
      { hour: "13:00", percentage: 58 },
      { hour: "14:00", percentage: 50 }
    ]},
    { day: "Rabu", time: "15:00 - 17:00", engagement: "tinggi", audience: "67%", hourlyBreakdown: [
      { hour: "14:00", percentage: 53 },
      { hour: "15:00", percentage: 61 },
      { hour: "16:00", percentage: 67 },
      { hour: "17:00", percentage: 60 }
    ]},
    { day: "Kamis", time: "10:00 - 12:00", engagement: "sedang", audience: "52%", hourlyBreakdown: [
      { hour: "09:00", percentage: 38 },
      { hour: "10:00", percentage: 46 },
      { hour: "11:00", percentage: 52 },
      { hour: "12:00", percentage: 47 }
    ]},
    { day: "Jumat", time: "14:00 - 16:00", engagement: "tinggi", audience: "72%", hourlyBreakdown: [
      { hour: "13:00", percentage: 58 },
      { hour: "14:00", percentage: 65 },
      { hour: "15:00", percentage: 72 },
      { hour: "16:00", percentage: 63 }
    ]},
    { day: "Sabtu", time: "12:00 - 15:00", engagement: "sangat tinggi", audience: "75%", hourlyBreakdown: [
    ...
    { day: "Minggu", time: "13:00 - 16:00", engagement: "tinggi", audience: "69%", hourlyBreakdown: [
  ...
  twitter: [
    { day: "Senin", time: "14:00 - 16:00", engagement: "tinggi", audience: "65%", hourlyBreakdown: [
      { hour: "13:00", percentage: 50 },
      { hour: "14:00", percentage: 59 },
      { hour: "15:00", percentage: 65 },
      { hour: "16:00", percentage: 57 }
    ]},
    { day: "Selasa", time: "09:00 - 11:00", engagement: "sedang", audience: "53%", hourlyBreakdown: [
      { hour: "08:00", percentage: 42 },
      { hour: "09:00", percentage: 48 },
      { hour: "10:00", percentage: 53 },
      { hour: "11:00", percentage: 45 }
    ]},
    { day: "Rabu", time: "16:00 - 18:00", engagement: "tinggi", audience: "68%", hourlyBreakdown: [
      { hour: "15:00", percentage: 52 },
      { hour: "16:00", percentage: 63 },
      { hour: "17:00", percentage: 68 },
      { hour: "18:00", percentage: 60 }
    ]},
    { day: "Kamis", time: "12:00 - 14:00", engagement: "sedang", audience: "59%", hourlyBreakdown: [
      { hour: "11:00", percentage: 48 },
      { hour: "12:00", percentage: 55 },
      { hour: "13:00", percentage: 59 },
      { hour: "14:00", percentage: 53 }
    ]},
    { day: "Jumat", time: "16:00 - 18:00", engagement: "tinggi", audience: "70%", hourlyBreakdown: [
      { hour: "15:00", percentage: 58 },
      { hour: "16:00", percentage: 65 },
      { hour: "17:00", percentage: 70 },
      { hour: "18:00", percentage: 62 }
    ]},
    { day: "Sabtu", time: "10:00 - 12:00", engagement: "rendah", audience: "45%", hourlyBreakdown: [
      { hour: "09:00", percentage: 32 },
      { hour: "10:00", percentage: 38 },
      { hour: "11:00", percentage: 45 },
      { hour: "12:00", percentage: 40 }
    ]},
    { day: "Minggu", time: "17:00 - 19:00", engagement: "tinggi", audience: "63%", hourlyBreakdown: [
...
const PostTimeOptimizer = ({ platform = "instagram" }: PostTimeOptimizerProps) => {
  const [optimalTimes, setOptimalTimes] = useState(mockOptimalTimes[platform as keyof typeof mockOptimalTimes]);
  const [selectedDay, setSelectedDay] = useState<string | null>(null);
  const [bestTime, setBestTime] = useState(bestTimes[platform as keyof typeof bestTimes]);
  const [strategies, setStrategies] = useState(platformStrategies[platform as keyof typeof platformStrategies]);

  useEffect(() => {
    setOptimalTimes(mockOptimalTimes[platform as keyof typeof mockOptimalTimes]);
    setBestTime(bestTimes[platform as keyof typeof bestTimes]);
    setStrategies(platformStrategies[platform as keyof typeof platformStrategies]);
    setSelectedDay(null);
  }, [platform]);
  ...
  const scheduleToOptimalTime = () => {
    toast.success(`Post berhasil dijadwalkan pada waktu optimal: ${bestTime.day} pukul ${bestTime.time}`);
  };
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Waktu terbaik untuk posting di {platform} berdasarkan engagement audience
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Berdasarkan data 30 hari terakhir</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="text-2xl font-bold">{peakTimeData.peakDay}, {peakTimeData.peakHour}</div>
                    <div className="text-sm text-green-700">{peakTimeData.percentage}% Audience Aktif</div>
                  </div>
                </div>
              </CardContent>
              <CardFooter className="bg-green-100 py-2 px-4 flex justify-between">
                <span className="text-sm text-green-800">Dapat meningkatkan engagement hingga 30%</span>
                <Button size="sm" onClick={scheduleToOptimalTime}>Jadwalkan Post</Button>
              </CardFooter>
            </Card>

            <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
              <Users className="h-4 w-4" />
              <span>Menampilkan persentase audience yang aktif pada waktu-waktu tertentu</span>
            </div>
              ...
              {optimalTimes.map((timeSlot, index) => (
                <div key={index} className="border rounded-md overflow-hidden">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      <Badge className={getEngagementBadge(timeSlot.engagement)}>
                        {timeSlot.engagement}
                      </Badge>
                  ...
                  {selectedDay === timeSlot.day && (
                    <div className="bg-slate-50 p-3 border-t">
                      <h4 className="text-sm font-medium mb-2">Breakdown per jam:</h4>
                      <div className="grid grid-cols-3 gap-2">
                        {timeSlot.hourlyBreakdown.map((hourData, hIdx) => (
                          <div key={hIdx} className="bg-white p-2 rounded border text-center">
                            <div className="text-sm font-medium">{hourData.hour}</div>
                            <div className="text-xs text-muted-foreground">{hourData.percentage}% aktif</div>
                          </div>
                        ))}
                      </div>
                    </div>
        ...
        <CardFooter className="flex justify-between text-xs text-muted-foreground border-t pt-4">
          <div>
            Data didasarkan pada aktivitas audience dari akun {platform} Anda dalam 30 hari terakhir.
          </div>
